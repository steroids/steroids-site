...
//    'form.HtmlFieldView': {lazy: () => require('@steroidsjs/bootstrap/form/HtmlField/HtmlFieldView').default},
    ...
    'list.SubtitleColumnView': {lazy: () => require('@steroidsjs/bootstrap/list/Grid/views/SubtitleColumnView/SubtitleColumnView').default},
    'list.LinkColumnView': {lazy: () => require('@steroidsjs/bootstrap/list/Grid/views/LinkColumnView/LinkColumnView').default},
    'list.AvatarColumnView': {lazy: () => require('@steroidsjs/bootstrap/list/Grid/views/AvatarColumnView/AvatarColumnView').default},
    'list.IconColumnView': {lazy: () => require('@steroidsjs/bootstrap/list/Grid/views/IconColumnView/IconColumnView').default},
    'list.PictureColumnView': {lazy: () => require('@steroidsjs/bootstrap/list/Grid/views/PictureColumnView/PictureColumnView').default},
